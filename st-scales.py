...
style_img2 = image_loader("./StyleImages/autumn.jpg")
style_img = image_loader("./StyleImages/picasso.jpg")
...
style_layers_default2 = ['conv_3', 'conv_4', 'conv_5']

def get_style_model_and_losses(cnn, normalization_mean, normalization_std,
                               style_img, content_img, style_img2, 
                               content_layers=content_layers_default,
                               style_layers=style_layers_default, \
                                       style_layers2=style_layers_default2):
...
def run_style_transfer(cnn, normalization_mean, normalization_std,
                       ...
                       style_weight=500000, style_weight2=500000, content_weight=100):
