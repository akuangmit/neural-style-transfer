...
style_img_yiq = image_loader("./StyleImages/bluesky.jpg",True)
...
plt.figure()
imshow(lol, title='Content Image')
# plt.figure()
...
output_gray = run_style_transfer(cnn, cnn_normalization_mean, cnn_normalization_std,
                            content_img_gray, style_img_gray, input_img) #Apply style transfer on luminance-only images
