...
content_img_yiq = image_loader("./ContentImages/dancing.jpg", True)
content_img_gray = L_channel(content_img_yiq)
content_img_iq = IQ_channel(content_img_yiq)

color_img_yiq = image_loader("./StyleImages/brightPicasso.jpg", True)
...
# print(color_img_gray.max())
# print(color_img_gray.min())
# print(torch.histc(color_img_gray).shape)
# exit()

style_img_yiq = image_loader("./StyleImages/brightPicasso.jpg",True)
style_img_iq = IQ_channel(style_img_yiq)
style_img_gray = L_channel(style_img_yiq)
# style_img_gray = L_normalize(content_img_gray, style_img_gray)
# print(content_img.size())
# print(style_img.size())

# plt.plot(torch.histc(color_img_gray).numpy(), label='Autumn')
# plt.plot(torch.histc(content_img_gray).numpy(), label='Stata')
# plt.plot(torch.histc(style_img_gray).numpy(), label='Picasso')
...
# def combineColorAndGrayscale(originalImage, styleTransferredImage):
...
output_gray = run_style_transfer(cnn, cnn_normalization_mean, cnn_normalization_std,
                            content_img_gray, style_img_gray, input_img)
output = yiq2rgb(output_gray.data, color_img_iq)
output = yiq2rgb(output_gray.data, color_img_iq)
