...
def image_loader_luminance(image_name):
    rgbImage = Image.open(image_name)
    luminanceImage = rgbImage.convert('L')
    # fake batch dimension required to fit network's input dimensions
    luminanceImage = loader(luminanceImage).unsqueeze(0)
    return luminanceImage.to(device, torch.float)
content_img_rgb = image_loader("./ContentImages/stata.jpg")
content_img = image_loader_luminance("./ContentImages/stata.jpg")
style_img = image_loader_luminance("./StyleImages/picasso.jpg")
...
def run_style_transfer(cnn, normalization_mean, normalization_std,
                       ...
                       style_weight=1000000, content_weight=1): #content weight of 
...
#output = #Transfer color channels to outputLuminance!
